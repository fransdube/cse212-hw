...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: The original implementation didn't properly handle cases where turns were exactly 1
    // and didn't re-enqueue people with infinite turns (0 or negative)
    ...
    // Defect(s) Found: The original implementation didn't properly handle adding new people mid-process
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: The original implementation didn't properly handle infinite turns (0)
    ...
    // Defect(s) Found: The original implementation didn't properly handle infinite turns (negative numbers)
